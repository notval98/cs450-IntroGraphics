...
GLuint  BladeList;              // plane blade display list
GLuint	PlaneList;				// draw plane
GLuint	TorusList;				// draw torus
int		WhichViewPerspective;	// OUTSIDE or INSIDE
bool	Frozen;					// sets if scene is frozen
...
Display()
{
	...
	if (WhichViewPerspective == INSIDE) {
		// A good eye poition for your Inside View is (0., 1.2, 1.)
		// A good look-at position for your Inside View is (0., 5., 10.)
		gluLookAt(0., 0., 1., 0., -5., 10., 0., 1., 0.);
	}
	else {
