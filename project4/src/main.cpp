...
const char* WINDOWTITLE = "OpenGL / GLUT Sample -- Michael Hwang";
...
Display()
{
	...
	SetPointLight(GL_LIGHT0, l1pos.x, l1pos.y, l1pos.z, 0.75, 0.75, 0.75);
	glPopMatrix();
	...
	glColor3f(0., 0., 1.);
	glutSolidSphere(0.05, 50, 50);
	SetPointLight(GL_LIGHT2, l2pos.x, l2pos.y, l2pos.z, 0., 0., 1.);
	glPopMatrix();
	...
	glColor3f(1., 0., 0.);
	glutSolidSphere(0.05, 50, 50);
	SetSpotLight(GL_LIGHT1, l0pos.x, l0pos.y, l0pos.z, -l0pos.x, -l0pos.y, -l0pos.z, 1., 0., 0.);
	glPopMatrix();
	...
	OsuSphere(SPHERE_RADIUS / 1.5, SPHERE_SLICES, SPHERE_STACKS);
